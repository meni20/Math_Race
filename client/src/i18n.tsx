...
const STRINGS = {
  he: {
    ...
    goHome: "מסך ראשי",
    cannotConnectServer: "לא ניתן להתחבר לשרת הכיתה. הדמו ב-Firebase עדיין יכול לעבוד מקומית בדפדפן הזה.",
    username: "שם משתמש",
    password: "סיסמה",
    role: "תפקיד",
    teacher: "מורה",
    ...
    authUnavailable: "משתמשים נשמרים מקומית בדפדפן עבור הדמו ב-Firebase.",
  ...
  en: {
    ...
    goHome: "Main screen",
    cannotConnectServer: "Cannot connect to the classroom backend. The Firebase-hosted demo can still run locally in this browser.",
    username: "Username",
    password: "Password",
    role: "Role",
    teacher: "Teacher",
    ...
    authUnavailable: "Users are stored locally in this browser for the Firebase-hosted demo.",
