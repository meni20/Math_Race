  ...
  return (
    <form className="flex flex-1 py-6" onSubmit={submit}>
      <section className="w-full rounded-lg border border-white/10 bg-white/6 p-5">
        <h2 className="text-lg font-black text-white">Create race room</h2>
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          ...
          <label className="block">
            <span className="mb-1.5 block text-[11px] font-bold uppercase tracking-[0.14em] text-cyan-100/70">Room code</span>
            <input
          ...
          <label className="block">
            <span className="mb-1.5 block text-[11px] font-bold uppercase tracking-[0.14em] text-cyan-100/70">Map / track</span>
            <select
              className="w-full rounded-lg border border-white/10 bg-slate-950/50 px-3 py-2.5 text-sm text-white outline-none focus:border-cyan-100/40"
